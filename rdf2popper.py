...
def rdf2popper(file_name, head_pred_name, negative_predicate, output_directory='output', output_prefix = 'rdf2popper',
    ...
    for triple in bk_list:
        ...
        # elif triple[1][-3:] in GREATER_ARITY_SUFFIX_1:
        #     bk_output_list.append(f'{triple[1]}({triple[2]}).')
        #     greater_arity_helper_1[triple[0]] = triple[2]
        #     if triple[0] in greater_arity_helper_2.keys():
        #         bk_output_list.append(f'{triple[1][:-1]}2({triple[2]},{greater_arity_helper_2[triple[0]]}).')
        #     if triple[0] in greater_arity_helper_3.keys():
        #         bk_output_list.append(f'{triple[1][:-1]}3({triple[2]},{greater_arity_helper_3[triple[0]]}).')
        # elif triple[1][-3:] in GREATER_ARITY_SUFFIX_2:
        #     if triple[0] in greater_arity_helper_1.keys():
        #         bk_output_list.append(f'{triple[1]}({greater_arity_helper_1[triple[0]]},{triple[2]}).')
        #     else:
        #         greater_arity_helper_2[triple[0]] = triple[2]
        # elif triple[1][-3:] in GREATER_ARITY_SUFFIX_3:
        #     if triple[0] in greater_arity_helper_1.keys():
        #         bk_output_list.append(f'{triple[1]}({greater_arity_helper_1[triple[0]]},{triple[2]}).')
        #     else:
        #         greater_arity_helper_3[triple[0]] = triple[2]
        else:
